import type { RuntimeEnv } from "code/plugin-sdk/runtime-env";
import type { WizardPrompter } from "code/plugin-sdk/setup";
import { jsonResponse, requestBodyText, requestUrl } from "code/plugin-sdk/test-env";
...
vi.mock("code/plugin-sdk/ssrf-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("code/plugin-sdk/ssrf-runtime")>();
  return {
    ...actual,
        ...
        agents: {
          defaults: {
            model: {
              ...
              fallbacks: ["chronokairo/code-orange-4-5"],
            },
          },
        },
      },
