...
vi.mock("code/plugin-sdk/provider-auth-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("code/plugin-sdk/provider-auth-runtime")>();
  return {
    ...actual,
