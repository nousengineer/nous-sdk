import { createSubsystemLogger } from "code/plugin-sdk/logging-core";
import type { ModelDefinitionConfig } from "code/plugin-sdk/provider-model-shared";
import { SELF_HOSTED_DEFAULT_COST } from "code/plugin-sdk/provider-setup";
import { fetchWithSsrFGuard, type SsrFPolicy } from "code/plugin-sdk/ssrf-runtime";
...
/** Discovers LLM models from LM Studio and maps them to code model definitions. */
