import {
  ...
  type codeConfig,
} from "code/plugin-sdk/provider-onboard";
...
export function applyNvidiaProviderConfig(cfg: codeConfig): codeConfig {
  return nvidiaPresetAppliers.applyProviderConfig(cfg);
}

export function applyNvidiaConfig(cfg: codeConfig): codeConfig {
